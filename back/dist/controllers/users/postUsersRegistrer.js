...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, email, birthdate, nDni, username, password, createUser, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4, (0, userServices_1.createUserService)({ name: name, email: email, birthdate: birthdate, nDni: nDni }, { username: username, password: password })];
            case 1:
                createUser = _b.sent();
